...
namespace RA.Service
{
    public class Initializer
    {
        ...
        //    HostRepository HostRepo = new SqliteHostRepository(coreIdentity, logWriter);
        //    HostRepository.Initialize();
        //    unityDiContainer.RegisterInstance<ISensorHostInfoRepository>(HostRepository);
